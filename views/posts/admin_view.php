...
$last_post = Posts_view::last_post_view_admin();
$id = Posts_insert::last_post_id2();
?>

<div class="admin-view-post">

<div class="panel panel-default" style="border:0px solid #fff;margin:0px;">
<div class="panel-heading"><h3><?php echo $last_post->post_title; ?></h3></div>
...
<div class="post-about">
<div class="author"><strong>By: </strong><span><?php echo ucfirst($last_post->post_author); ?></span></div>
<div class="date"><strong>Date: </strong><span><?php echo $last_post->get_post_date($last_post->post_id); ?> at <?php echo $last_post->get_post_time($last_post->post_id); ?></span></div>
</div>

<div class="post-introduction">
<?php echo html_entity_decode($last_post->post_introduction); ?>

</div>

<?php
if($last_post->post_image === "none"){
}else{
 ?>
<div class="post-image">
<img src="<?php echo Config::get("path").Config::get("image_dir").$last_post->post_image; ?>" width="400">
</div>
<?php } ?>
...
<div class="post-content">
<?php echo html_entity_decode($last_post->post_content);  ?>
</div>
