...
INSERT INTO `iw_users` (`user_id`, `username`, `password`, `first_name`, `last_name`, `born_date`, `email`, `country`, `city`, `user_status`, `register_date`, `phone_number`, `user_gender`, `user_address`, `user_activation`, `new_psw`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'Admin', 'Admin', NULL, 'your@email.com', NULL, NULL, 351, '', NULL, NULL, NULL, NULL, '58797e215fdd2');

CREATE TABLE `iw_user_activity` (
...
INSERT INTO `iw_user_status` (`id`, `status_number`, `status_name`) VALUES
(1, 351, 'Owner'),
(2, 0, 'Inactive'),
